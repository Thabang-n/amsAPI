...
namespace Services.ReferenceData
{
    public class LookUpService : ILookUpService
    {
        ...
        public LookUpService(IGenericRepo<Brand> brandRepo,IGenericRepo<LocationDto> locationRepo,IGenericRepo<Feature> featureRepo, IGenericRepo<Category> categoryRepo, amsDbContext context)
        {
        ...
        async Task<List<BrandDto>> ILookUpService.GetBrandsAsync()
        {
        ...
        async Task<List<LocationDto>> ILookUpService.GetLocationsAsync()
        {
