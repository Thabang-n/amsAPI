...
{
    public class AssetResponseListMapper
    {
        public static List<AssetResponseDto> ConvertToDtoList(List<Asset> assets)
        {
            return assets.Select(asset => new AssetResponseDto
            {
                Id = asset.AssetId,
